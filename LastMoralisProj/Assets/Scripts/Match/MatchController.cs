...
public class MatchController : MonoBehaviour
{
    ...
    private static GameObject objectNFT;


    private IEnumerator awaitAndShow()
    {
    ...
    private void Update()
    {
        if (hexagramCounter == 6)
        {
            ...
            objectNFT = (hexagramNumberArray[0], hexagramNumberArray[1], hexagramNumberArray[2]) switch
            {
